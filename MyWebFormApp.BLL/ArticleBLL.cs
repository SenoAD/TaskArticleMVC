...
namespace MyWebFormApp.BLL
{
    public class ArticleBLL : IArticleBLL
    {
        ...
        public int GetCountCategories(int id)
        {
            return _articleDAL.GetCountCategories(id);
        }

        public IEnumerable<ArticleDTO> GetWithPaging(int pageNumber, int pageSize, int id)
        {

            List<ArticleDTO> listArticlesDto = new List<ArticleDTO>();
            var articles = _articleDAL.GetWithPaging(pageNumber, pageSize, id);
            foreach (var article in articles)
            {
                listArticlesDto.Add(new ArticleDTO
                {
                    ArticleID = article.ArticleID,
                    CategoryID = article.CategoryID,
                    Title = article.Title,
